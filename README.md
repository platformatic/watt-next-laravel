...
- **`web/symfony`** - Symfony backend powered by Platformatic PHP
...
- **Location**: `web/symfony/`
- **Runtime**: Platformatic PHP
- **Content**: Standard Symfony installation
...
3. Symfony serves as the content management system
...
**Note**: The Symfony demo included in this project (`web/symfony/public`) is released under the MIT License. See the license file at `https://github.com/symfony/demo/blob/main/LICENSE` for full GPL license terms.
